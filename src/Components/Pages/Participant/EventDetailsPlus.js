...
import MentorContent from './Content/MentorContent'


const EventDetailsPlus = () => {
  ...
  return (
    <div className='text-xl font-sansBold mt-[20px] flex text-white flex-col justify-center items-center'>
        ...
        <img className='w-[30vw]' src='/VectorParticipant.svg' />
        <div className='flex justify-between w-[35vw]'>
        {['General','Mentors', 'Submission', 'Reports'].map((tab) => (
          <button
            key={tab}
...
export default EventDetailsPlus